...
class IntegrationTests(TestCase):
    ...
    def test_player_play(self):
        ...
        self.players[0].play(game)
        self.players[2].play(game)

        self.assertEqual(round(self.players[0].elo, 0), 2018)
        self.assertEqual(round(self.players[2].elo, 0), 2082)

    def test_get_elo_after2(self):
        game = factories.GameFactory.create(team1=(self.players[0],),
